          ...
          .col.col-12.col-md-6.col-lg-4.mt-4
            .tarjeta-text-up
              ...
              .tarjeta-text-up__texto
                ...
                p.mb-0 Tiene como fin controlar las actividades de los operadores del almacén, siendo un complemento del WMS. Con este sistema se logra mejorar la productividad del almacén, como consecuencia de la mejora en el desempeño de los trabajadores y el aprovechamiento de los recursos.
          .col.col-12.col-md-6.col-lg-4.mt-4
            .tarjeta-text-up
          ...
          .col.col-12.col-md-6.col-lg-4.mt-4
            .tarjeta-text-up
              ...
              .tarjeta-text-up__texto
                ...
                p.mb-0 Es representado gráficamente por un rectángulo compuesto de barras y espacios claros y oscuros permitiendo así la lectura a través de un lector óptico.
